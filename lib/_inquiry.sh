...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Authchat, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Authchat\n"
  printf "   [1] Atualizar Authchat\n"
  printf "   [2] Deletar Authchat\n"
  printf "   [3] Bloquear Authchat\n"
  printf "   [4] Desbloquear Authchat\n"
  printf "   [5] Alter. dominio Authchat\n"
  printf "\n"
  read -p "> " option
