...
O Authchat é uma empresa distribuidora de White Label que possui uma solução de atendimentos via Whatsapp que aumenta a produtividade e organização das equipes

## 🚀 Começando

O repositório do Authchat possui 3 pastas importantes:
- backend
- frontend
- instalador
...
- [Instalador](https://github.com/authcomtecnologia/authchat)
...
⌨️ com ❤️ por [Authchat](https://github.com/authcomtecnologia/authchat) 😊

Todos os direitos reservados a https://github.com/authcomtecnologia/authchat
